...
<body>
    <div class="center">
        <a href="/">
            <img src="img/logo_troover.png" height="64" alt="logo de troover">
        </a>
    </div>
    <h1>Conditions Générales d'Utilisation</h1>
    <h3>Bienvenue sur MyRSS ! En utilisant notre site, vous acceptez les conditions générales d'utilisation suivantes :</h3>
